...
class CarteiraKleuber extends Component {
        ...
        return (
            ...
            <div>
                ...
                <div class="column is-half is-offset-one-quarter">
                    ...
                    <div class="block">
                        <img src={carteirinhaKleuber} alt='carteirinha Kleuber' id="carteirinhafoto"/>
                    </div>
                    ...
                    <div class="columns is-mobile">
                        <div class="column is-half is-offset-one-quarter">
                            ...
                            <div  class="block">
                                <img src={qrCodeKleuber} alt='qr code Kleuber'/>
                            </div>
...
export default CarteiraKleuber;